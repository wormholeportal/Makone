 ...
 *
 * Per skills/three/shared-resources.md — every
...
export default async function createWorld(container) {
  ...
  // Chunky white cubes tinted per-particle by each burst's `color` — brick shards,
  // steel splinters, sparks and smoke all come out of this one emitter.
  const fxPS = new ParticleSystem(scene, {
    maxParticles: 300,
