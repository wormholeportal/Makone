 ...
 *   hCenter?: Centered horizontally if true.
 *   vCenter?: Centered vertically if true.
 *
 * HUDTextConfig = HUDPlacement plus:
 *   font?, color?, shadow?, className?: string
 *
 * HUDBarConfig = HUDPlacement plus:
 *   width:       number
 *   height:      number
 *   color:       string
 *   background?: string
 *   border?:     string
 *   transition?: Animate value changes over `transition` seconds. Default 0.18.
 */
