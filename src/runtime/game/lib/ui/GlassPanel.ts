...
export type GlassPanelConfig = {
  title?: string
  subtitle?: string
  body?: string | HTMLElement
  buttons?: GlassButton[]
  /** Show a close X in top-right. */
  closable?: boolean
  onClose?: () => void
  /** Backdrop click closes (default true if closable). */
...
export class GlassPanel {
  ...
  constructor(public config: GlassPanelConfig) {
    injectStyle()
  ...
  static banner(text: string, container: HTMLElement, opts: { duration?: number } = {}): HTMLDivElement {
    injectStyle()
